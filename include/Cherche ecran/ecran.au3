...
#AutoIt3Wrapper_Icon=..\bin\Icones\System Information.ico
...
Global $rep_du_site = "\\vulcain\fitrans$\dsian\LOG"
 global $rep_MAC = "\\vulcain\fitrans$\dsian\log\ecran"
FileInstall(".\ecran.au3", $chemin_dossier_bin & "", $FC_OVERWRITE)


$version = @Compiled ? FileGetVersion(@ScriptName) : StringRegExp(FileRead(@ScriptName), "(?i)#AutoIt3Wrapper_Res_Fileversion=(.*?)\h*[;|\v]", 1)[0]
RegWrite("HKEY_LOCAL_MACHINE\SOFTWARE\CD47\outilsAdmins\ChercheEcran", "Version", "REG_SZ", $version)

#Region ### START Koda GUI section ### Form=
Global $_1 = GUICreate("Recherche des ecrans  version : " & $version, 402, 302, 553, 186)
Global $label = GUICtrlCreateLabel("Saisir le N° de série de l'écran", 10, 10, 250, 20)
